...
public class CountingGenerator {
    ...
    public static class BerylliumSphere implements Generator<com.github.frankkwok.tij4.arrays.BerylliumSphere> {
        @Override
        public com.github.frankkwok.tij4.arrays.BerylliumSphere next() {
            return new com.github.frankkwok.tij4.arrays.BerylliumSphere();
        }
    }
    ...
    public static class BigDecimal implements Generator<java.math.BigDecimal> {
        ...
        public java.math.BigDecimal next() {
            return value.add(java.math.BigDecimal.ONE);
        }
    }
}
